...
const trashFormatter = new Intl.NumberFormat("pt-br", {
...
function exibeAlert(){
  alert("❗Quanto menos dinheiro mais lixo❗");
}
setTimeout(exibeAlert, 1000);


async function setupTrash() {
  const amountRaised = Math.floor(Math.random() * 30000000 + 1)
